 ...
 */
package de.cau.cs.kieler.klighd.xtext.view.syntheses.action;
...
import de.cau.cs.kieler.klighd.xtext.view.syntheses.EcoreModelSynthesis;
...
public class EcoreModelExpandDetailsAction implements IAction {
    ...
    public static final String ID =
            "de.cau.cs.kieler.klighd.xtext.view.syntheses.action.EcoreModelExpandDetailsAction";
