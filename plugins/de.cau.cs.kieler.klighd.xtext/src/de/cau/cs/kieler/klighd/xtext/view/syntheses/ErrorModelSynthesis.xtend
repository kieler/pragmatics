...
import de.cau.cs.kieler.klighd.xtext.view.syntheses.action.ErrorModelShowExceptionAction
...
class ErrorModelSynthesis extends AbstractDiagramSynthesis<ErrorModel> {
    ...
    // -------------------------------------------------------------------------
    // Constants
    public static val String ID = "de.cau.cs.kieler.klighd.xtext.view.syntheses.ErrorModelSynthesis";
