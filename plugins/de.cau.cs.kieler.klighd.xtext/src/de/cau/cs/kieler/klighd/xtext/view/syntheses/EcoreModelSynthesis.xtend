 ...
 */
package de.cau.cs.kieler.klighd.xtext.view.syntheses
...
import de.cau.cs.kieler.klighd.xtext.view.syntheses.action.EcoreModelExpandDetailsAction
...
class EcoreModelSynthesis extends AbstractDiagramSynthesis<EObject> {
    ...
    // -------------------------------------------------------------------------
    // Constants
    public static val String ID = "de.cau.cs.kieler.klighd.xtext.view.syntheses.EcoreModelSynthesis";
    ...
    override KNode transform(EObject model) {
        ...
        // TODO activate (add plugin dependencies)
