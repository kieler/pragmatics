 ...
 * generated
 */
public class FeatureDefinitionExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(FeatureDefinitionExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		de.cau.cs.kieler.ksbase.internal.FeatureDefinitionActivator instance = de.cau.cs.kieler.ksbase.internal.FeatureDefinitionActivator.getInstance();
		if (instance == null)
		...
		try {
			...
			final Injector injector = de.cau.cs.kieler.ksbase.internal.FeatureDefinitionActivator.getInstance().getInjector("de.cau.cs.kieler.ksbase.FeatureDefinition");
