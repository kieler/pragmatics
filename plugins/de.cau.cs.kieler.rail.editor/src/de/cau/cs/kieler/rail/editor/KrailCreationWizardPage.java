...
public class KrailCreationWizardPage extends WizardNewFileCreationPage {
     ...
     */
    public KrailCreationWizardPage(final String pageName, final IStructuredSelection selection,
    ...
    private String copyFileName() {
        ...
        if (previousPage instanceof KrailCreationWizardPage) {
        	KrailCreationWizardPage copyPage = (KrailCreationWizardPage) previousPage;
