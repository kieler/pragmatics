 ...
 */
package de.cau.cs.kieler.klighd.view.controller;
...
import de.cau.cs.kieler.klighd.view.KlighdViewPlugin;
...
public final class ViewUpdateControllerFactory {
    ...
    public static final String EXTP_ID_CONTROLLER = "de.cau.cs.kieler.klighd.view.controller";

    /** Identifier of the extension point for controllers. */
    public static final String EXTP_ID_EDITOR = "de.cau.cs.kieler.klighd.view.editor";
