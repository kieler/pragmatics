 ...
 */
package de.cau.cs.kieler.klighd.view.syntheses
...
import de.cau.cs.kieler.klighd.view.syntheses.action.EcoreModelExpandDetailsAction
...
class EcoreModelSynthesis extends AbstractDiagramSynthesis<EObject> {
    ...
    // -------------------------------------------------------------------------
    // Constants
    public static val String ID = "de.cau.cs.kieler.klighd.view.syntheses.EcoreModelSynthesis";
