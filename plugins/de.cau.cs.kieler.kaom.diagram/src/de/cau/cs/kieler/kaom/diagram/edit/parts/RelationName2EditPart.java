 ...
 * @generated
 */
public class RelationName2EditPart extends LabelEditPart implements
	 ...
	 * @generated
	 */
	public RelationName2EditPart(View view) {
		super(view);
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), KaomEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new RelationNameFigure();
	}

	/**
	 * @generated
	 */
	public class RelationNameFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RelationNameFigure() {
			this.setText("");
