...
public class KaomViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = KaomVisualIDRegistry.getNodeVisualID(op
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = KaomVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
	...
	public Node createPort_3001(EObject domainElement, View containerView,
		...
		Node label5001 = createLabel(node, KaomVisualIDRegistry
	...
	public Node createRelation_3003(EObject domainElement, View containerView,
		...
		Node label5002 = createLabel(node, KaomVisualIDRegistry
	...
	public Edge createLink_4001(EObject domainElement, View containerView,
		...
		Node label6001 = createLabel(edge, KaomVisualIDRegistry
