 ...
 * @generated
 */
public class EntityName2EditPart extends LabelEditPart implements ITextAwareEditPart,
        IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
                KaomVisualIDRegistry
                        .getType(de.cau.cs.kieler.kaom.diagram.edit.parts.EntityName2EditPart.VISUAL_ID),
                new Point(0, 0));
    }
    ...
    public void setLabelText(String text) {
        ...
        if (pdEditPolicy instanceof KaomTextSelectionEditPolicy) {
            ((KaomTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
        }
        Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
        if (sfEditPolicy instanceof KaomTextSelectionEditPolicy) {
            ((KaomTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
        }
    }
    ...
    protected IFigure createFigurePrim() {
        return new EntityNameFigure();
    }

    /**
     * @generated
     */
    public class EntityNameFigure extends WrappingLabel {

        /**
         * @generated
         */
        public EntityNameFigure() {
            this.setText("");
