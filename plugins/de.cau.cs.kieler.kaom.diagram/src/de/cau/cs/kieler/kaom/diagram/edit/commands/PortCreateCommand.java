...
public class PortCreateCommand extends EditElementCommand {
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        Port newElement = KaomFactory.eINSTANCE.createPort();

        Entity owner = (Entity) getElementToEdit();
        owner.getChildPorts().add(newElement);
     ...
     * @generated
     */
    protected void doConfigure(Port newElement, IProgressMonitor monitor, IAdaptable info)
        throws ExecutionException {
