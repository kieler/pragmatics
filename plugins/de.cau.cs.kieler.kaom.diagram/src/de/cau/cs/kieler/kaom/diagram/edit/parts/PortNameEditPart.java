 ...
 * @generated
 */
public class PortNameEditPart extends LabelEditPart implements ITextAwareEditPart,
    IBorderItemEditPart {
    ...
    static {
        registerSnapBackPosition(
            KaomVisualIDRegistry
                .getType(de.cau.cs.kieler.kaom.diagram.edit.parts.PortNameEditPart.VISUAL_ID),
            new Point(0, 0));
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = KaomParserProvider.getParser(KaomElementTypes.Port_3001, getParserElement(),
                KaomVisualIDRegistry
                    .getType(de.cau.cs.kieler.kaom.diagram.edit.parts.PortNameEditPart.VISUAL_ID));
        }
        return parser;
