...
public class KaomNavigatorContentProvider implements ICommonContentProvider {
    ...
    public Object[] getChildren(Object parentElement) {
        if (parentElement instanceof IFile) {
            ...
            ArrayList<KaomNavigatorItem> result =
                    new ArrayList<KaomNavigatorItem>();
            ...
            result.addAll(createNavigatorItems(
                    selectViewsByType(topViews, EntityEditPart.MODEL_ID), file,
                    false));
    ...
    private Object[] getViewChildren(View view, Object parentElement) {
        ...
        case Entity2EditPart.VISUAL_ID: {
            LinkedList<KaomAbstractNavigatorItem> result =
                    new LinkedList<KaomAbstractNavigatorItem>();
            Node sv = (Node) view;
            KaomNavigatorGroup incominglinks =
                    new KaomNavigatorGroup(
                            Messages.NavigatorGroupName_Entity_2001_incominglinks,
                            "icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
            KaomNavigatorGroup outgoinglinks =
                    new KaomNavigatorGroup(
            ...
            connectedViews =
                    getChildrenByType(connectedViews,
                            KaomVisualIDRegistry
                                    .getType(Entity3EditPart.VISUAL_ID));
            result.addAll(createNavigatorItems(connectedViews, parentElement,
                    false));
            connectedViews =
                    getChildrenByType(
            ...
            connectedViews =
                    getChildrenByType(connectedViews,
                            KaomVisualIDRegistry
                                    .getType(Relation2EditPart.VISUAL_ID));
            result.addAll(createNavigatorItems(connectedViews, parentElement,
                    false));
            connectedViews =
     ...
     * @generated
     */
    private Collection<KaomNavigatorItem> createNavigatorItems(
            Collection<View> views, Object parent, boolean isLeafs) {
        ArrayList<KaomNavigatorItem> result =
                new ArrayList<KaomNavigatorItem>(views.size());
        for (View nextView : views) {
    ...
    public Object getParent(Object element) {
        if (element instanceof KaomAbstractNavigatorItem) {
            KaomAbstractNavigatorItem abstractNavigatorItem =
                    (KaomAbstractNavigatorItem) element;
