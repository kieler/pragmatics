...
public class KaomNavigatorLabelProvider extends LabelProvider implements
	...
	private Image getImage(String key, IElementType elementType) {
		ImageRegistry imageRegistry = KaomDiagramEditorPlugin.getInstance()
				.getImageRegistry();
	...
	private String getPort_3001Text(View view) {
		IParser parser = KaomParserProvider.getParser(
				KaomElementTypes.Port_3001, view.getElement() != null ? view
						.getElement() : view, KaomVisualIDRegistry
	...
	private String getLink_4001Text(View view) {
		IParser parser = KaomParserProvider.getParser(
				KaomElementTypes.Link_4001, view.getElement() != null ? view
						.getElement() : view, KaomVisualIDRegistry
