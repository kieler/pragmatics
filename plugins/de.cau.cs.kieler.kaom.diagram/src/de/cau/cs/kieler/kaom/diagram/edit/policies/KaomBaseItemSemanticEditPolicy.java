...
public class KaomBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(KaomVisualIDRegistry
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateLink_4001(Entity container,
		 ...
		 * @generated
		 */
		public static boolean canExistLink_4001(Entity container,
				Linkable source, Linkable target) {
			return true;
		}
	}
