 ...
 * @generated
 */
public class Relation2EditPart extends AdvancedRenderingBorderedShapeEditPart {
    ...
    public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
        ...
        if (targetEditPart instanceof de.cau.cs.kieler.kaom.diagram.edit.parts.Relation2EditPart) {
            types.add(KaomElementTypes.Link_4001);
        }
        return types;
    }
