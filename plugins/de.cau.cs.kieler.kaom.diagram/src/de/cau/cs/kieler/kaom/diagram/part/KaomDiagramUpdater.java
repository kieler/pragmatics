...
public class KaomDiagramUpdater {
	 ...
	 * @generated
	 */
	public static List<KaomNodeDescriptor> getEntityEntityCompartment_7001SemanticChildren(
			View view) {
	 ...
	 * @generated
	 */
	public static List<KaomNodeDescriptor> getEntityEntityCompartment_7002SemanticChildren(
			View view) {
		if (false == view.eContainer() instanceof View) {
			return Collections.emptyList();
		}
