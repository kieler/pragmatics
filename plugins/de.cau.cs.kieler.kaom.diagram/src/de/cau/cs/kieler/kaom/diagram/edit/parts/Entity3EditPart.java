...
public class Entity3EditPart extends AbstractBorderedShapeEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new Entity3CanonicalEditPolicy());
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof EntityName2EditPart) {
            ((EntityName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureEntityNameLabel());
            return true;
        }
