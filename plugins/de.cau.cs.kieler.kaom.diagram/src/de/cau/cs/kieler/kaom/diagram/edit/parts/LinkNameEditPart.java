...
public class LinkNameEditPart extends LabelEditPart implements ITextAwareEditPart {
    ...
    static {
        registerSnapBackPosition(
            KaomVisualIDRegistry
                .getType(de.cau.cs.kieler.kaom.diagram.edit.parts.LinkNameEditPart.VISUAL_ID),
            new Point(0, 40));
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new EntityEditPart.LinkLabelDragPolicy());
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = KaomParserProvider.getParser(KaomElementTypes.Link_4001, getParserElement(),
                KaomVisualIDRegistry
                    .getType(de.cau.cs.kieler.kaom.diagram.edit.parts.LinkNameEditPart.VISUAL_ID));
        }
        return parser;
     ...
     * @generated
     */
    public class LinkNameFigure extends WrappingLabel {
