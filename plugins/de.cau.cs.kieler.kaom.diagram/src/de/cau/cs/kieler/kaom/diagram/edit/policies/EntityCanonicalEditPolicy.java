...
public class EntityCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				KaomLinkDescriptor nextLinkDescriptor = (KaomLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final KaomLinkDescriptor nextLinkDescriptor = (KaomLinkDescriptor) linkDescriptorsIterator
					.next();
