 ...
 */
package de.cau.cs.kieler.config.text.services;
...
public class LayoutConfigGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RootNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.config.text.LayoutConfig.RootNode");
	...
	public class ElkNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.config.text.LayoutConfig.ElkNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RefElkNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.cau.cs.kieler.config.text.LayoutConfig.RefElkNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cIdentifierAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cIdentifierIDTerminalRuleCall_0_0 = (RuleCall)cIdentifierAssignment_0.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("de.cau.cs.kieler.config.text.LayoutConfig".equals(grammar.getName())) {
				return grammar;
			}
