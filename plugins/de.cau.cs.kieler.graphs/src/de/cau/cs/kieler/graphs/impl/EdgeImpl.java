 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getHeadLabel1 <em>Head Label1</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getHeadLabel2 <em>Head Label2</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getMidLabel <em>Mid Label</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getTailLabel1 <em>Tail Label1</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getTailLabel2 <em>Tail Label2</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#isIsDirected <em>Is Directed</em>}</li>
 *   <li>{@link de.cau.cs.kieler.graphs.impl.EdgeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
