...
public class GmfDiagramLayoutManager extends DiagramLayoutManager {
     ...
     * @author haf, cmot
     */
    private void addDummyEdgesForInterlevelConnections(final KNode graph) {
        ...
        for (Object obj : currentEditPart.getChildren()) {
            ...
            if (obj instanceof AbstractBorderItemEditPart) {
                ...
                if (!KimlUiUtil.isNoLayout(childNodeEditPart)) {
                    ...
                    if (kinsets == null) {
                        kinsets = KimlUtil.getShapeLayout(parentLayoutNode).getProperty(
    ...
    private void processConnections() {
        ...
        for (ConnectionEditPart connection : connections) {
            ...
            KInsets insets = KimlUtil.getShapeLayout(sourceNode.getParent()).getProperty(
                LayoutOptions.INSETS);
