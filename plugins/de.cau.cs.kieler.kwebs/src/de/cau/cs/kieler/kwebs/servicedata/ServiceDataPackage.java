...
public interface ServiceDataPackage extends EPackage {
     ...
     * @ordered
     */
    int LAYOUT_ALGORITHM__PREVIEW_IMAGE = 8;
    ...
    /**
     * Returns the meta object for the attribute '{@link de.cau.cs.kieler.kwebs.servicedata.LayoutAlgorithm#getPreviewImage <em>Preview Image</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Preview Image</em>'.
     * @see de.cau.cs.kieler.kwebs.servicedata.LayoutAlgorithm#getPreviewImage()
     * @see #getLayoutAlgorithm()
     * @generated
     */
    EAttribute getLayoutAlgorithm_PreviewImage();
    ...
    interface Literals {
         ...
         * @generated
         */
        EAttribute LAYOUT_ALGORITHM__PREVIEW_IMAGE = eINSTANCE.getLayoutAlgorithm_PreviewImage();
