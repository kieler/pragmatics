 ...
 */
package de.cau.cs.kieler.config.text.ide.contentassist.antlr;

import com.google.inject.Inject;
import de.cau.cs.kieler.config.text.ide.contentassist.antlr.internal.InternalLayoutConfigParser;
...
public class LayoutConfigParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalLayoutConfigParser createParser() {
		InternalLayoutConfigParser result = new InternalLayoutConfigParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRefElkNodeAccess().getGroup(), "rule__RefElkNode__Group__0");
					...
					put(grammarAccess.getElkNodeAccess().getIdentifierAssignment_0(), "rule__ElkNode__IdentifierAssignment_0");
					put(grammarAccess.getElkNodeAccess().getPropertiesAssignment_2(), "rule__ElkNode__PropertiesAssignment_2");
					put(grammarAccess.getElkNodeAccess().getChildrenAssignment_3_1(), "rule__ElkNode__ChildrenAssignment_3_1");
					put(grammarAccess.getRefElkNodeAccess().getIdentifierAssignment_0(), "rule__RefElkNode__IdentifierAssignment_0");
					put(grammarAccess.getRefElkNodeAccess().getPropertiesAssignment_2(), "rule__RefElkNode__PropertiesAssignment_2");
