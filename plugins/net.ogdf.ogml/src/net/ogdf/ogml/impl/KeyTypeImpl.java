...
public class KeyTypeImpl extends EObjectImpl implements KeyType {
     ...
     * @ordered
     */
    protected EList<KeyValueType> keyValue;
    ...
    protected EClass eStaticClass() {
        return OgmlPackage.Literals.KEY_TYPE;
    }
    ...
    public EList<KeyValueType> getKeyValue() {
        if (keyValue == null) {
            keyValue = new EObjectContainmentEList<KeyValueType>(KeyValueType.class, this, OgmlPackage.KEY_TYPE__KEY_VALUE);
        }
        return keyValue;
    }
    ...
    public void setId(String newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OgmlPackage.KEY_TYPE__ID, oldId, id));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case OgmlPackage.KEY_TYPE__KEY_VALUE:
