...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Target Style Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface TargetStyleType extends EObject {
     ...
     * @see #setColor(String)
     * @see net.ogdf.ogml.OgmlPackage#getTargetStyleType_Color()
    ...
    /**
     * Sets the value of the '{@link net.ogdf.ogml.TargetStyleType#getColor <em>Color</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.ogdf.ogml.OgmlPackage#getTargetStyleType_Type()
    ...
    /**
     * Sets the value of the '{@link net.ogdf.ogml.TargetStyleType#getType <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
     * Unsets the value of the '{@link net.ogdf.ogml.TargetStyleType#getType <em>Type</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see #isSetType()
     * @see #getType()
    ...
    /**
     * Returns whether the value of the '{@link net.ogdf.ogml.TargetStyleType#getType <em>Type</em>}' attribute is set.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setUri(String)
     * @see net.ogdf.ogml.OgmlPackage#getTargetStyleType_Uri()
    ...
    /**
     * Sets the value of the '{@link net.ogdf.ogml.TargetStyleType#getUri <em>Uri</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see net.ogdf.ogml.OgmlPackage#getTargetStyleType_Width()
    ...
    /**
     * Sets the value of the '{@link net.ogdf.ogml.TargetStyleType#getWidth <em>Width</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
