 ...
 *   <li>{@link de.cau.cs.kieler.uml.sequence.text.sequence.OneLifelineEndBlock#isEndBlock <em>End Block</em>}</li>
...
public interface OneLifelineEndBlock extends Interaction
{
   ...
   * @see de.cau.cs.kieler.uml.sequence.text.sequence.SequencePackage#getOneLifelineEndBlock_EndBlock()
   * @model
   * @generated
   */
  boolean isEndBlock();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.uml.sequence.text.sequence.OneLifelineEndBlock#isEndBlock <em>End Block</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
