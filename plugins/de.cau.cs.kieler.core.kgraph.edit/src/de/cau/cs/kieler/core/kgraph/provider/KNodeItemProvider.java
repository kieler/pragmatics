...
/**
 * This is the item provider adapter for a {@link de.cau.cs.kieler.core.kgraph.KNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KNodeItemProvider
     ...
     * @generated
     */
    public KNodeItemProvider(AdapterFactory adapterFactory) {
    ...
    public Object getImage(Object object) {
        return overlayImage(object, getResourceLocator().getImage("full/obj16/KNode"));
    }
    ...
    public String getText(Object object) {
        return getString("_UI_KNode_type");
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(KNode.class)) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (KGraphPackage.Literals.KNODE__CHILDREN,
                 KGraphFactory.eINSTANCE.createKNode()));

        newChildDescriptors.add
            (createChildParameter
                (KGraphPackage.Literals.KNODE__PORTS,
                 KGraphFactory.eINSTANCE.createKPort()));
