 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#getGlobalResources <em>Global Resources</em>}</li>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#getGloobalOutputs <em>Gloobal Outputs</em>}</li>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#isParallel <em>Parallel</em>}</li>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#isExecuteAll <em>Execute All</em>}</li>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#getExecute <em>Execute</em>}</li>
 *   <li>{@link de.cau.cs.kieler.grana.text.grana.Grana#getJobs <em>Jobs</em>}</li>
 * </ul>
 *
 * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana()
 * @model
 * @generated
 */
public interface Grana extends EObject
{
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_GlobalResources()
   ...
   * The list contents are of type {@link de.cau.cs.kieler.grana.text.grana.GlobalOutputRef}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_GloobalOutputs()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_Parallel()
   * @model
   * @generated
   */
  boolean isParallel();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.grana.text.grana.Grana#isParallel <em>Parallel</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_ExecuteAll()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.grana.text.grana.Grana#isExecuteAll <em>Execute All</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.cau.cs.kieler.grana.text.grana.Job}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_Execute()
   * @model
   * @generated
   */
   ...
   * @see de.cau.cs.kieler.grana.text.grana.GranaPackage#getGrana_Jobs()
   * @model containment="true"
   * @generated
   */
  EList<Job> getJobs();
