...
public class GranaSemanticSequencer extends ElkGraphSemanticSequencer {
	...
	protected void sequence_OutputReference(ISerializationContext context, OutputReference semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getOutputReferenceAccess().getOutputRefGlobalOutputRefIDTerminalRuleCall_1_0_1(), semanticObject.eGet(GranaPackage.Literals.OUTPUT_REFERENCE__OUTPUT_REF, false));
		feeder.finish();
	}
