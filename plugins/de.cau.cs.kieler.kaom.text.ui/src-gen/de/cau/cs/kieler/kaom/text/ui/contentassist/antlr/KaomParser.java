	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTopLevelEntityAccess().getAlternatives_1_4(), "rule__TopLevelEntity__Alternatives_1_4");
					put(grammarAccess.getTopLevelEntityAccess().getAlternatives_1_4_0_1(), "rule__TopLevelEntity__Alternatives_1_4_0_1");
					...
					put(grammarAccess.getTopLevelEntityAccess().getGroup_1_4_0(), "rule__TopLevelEntity__Group_1_4_0__0");
					...
					put(grammarAccess.getTopLevelEntityAccess().getAnnotationsAssignment_1_0(), "rule__TopLevelEntity__AnnotationsAssignment_1_0");
					put(grammarAccess.getTopLevelEntityAccess().getIdAssignment_1_2(), "rule__TopLevelEntity__IdAssignment_1_2");
					put(grammarAccess.getTopLevelEntityAccess().getNameAssignment_1_3(), "rule__TopLevelEntity__NameAssignment_1_3");
					put(grammarAccess.getTopLevelEntityAccess().getChildEntitiesAssignment_1_4_0_1_0(), "rule__TopLevelEntity__ChildEntitiesAssignment_1_4_0_1_0");
					put(grammarAccess.getTopLevelEntityAccess().getChildLinksAssignment_1_4_0_1_1(), "rule__TopLevelEntity__ChildLinksAssignment_1_4_0_1_1");
					put(grammarAccess.getTopLevelEntityAccess().getChildPortsAssignment_1_4_0_1_2(), "rule__TopLevelEntity__ChildPortsAssignment_1_4_0_1_2");
					put(grammarAccess.getTopLevelEntityAccess().getChildRelationsAssignment_1_4_0_1_3(), "rule__TopLevelEntity__ChildRelationsAssignment_1_4_0_1_3");
