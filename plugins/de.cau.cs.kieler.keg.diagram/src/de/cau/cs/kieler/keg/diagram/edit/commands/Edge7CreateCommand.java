 ...
 * @generated
 */
public class Edge7CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge7CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4007(getContainer(),
                getSource(), getTarget());
    }
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        ElementInitializers.getInstance().init_Edge_4007(newElement);
