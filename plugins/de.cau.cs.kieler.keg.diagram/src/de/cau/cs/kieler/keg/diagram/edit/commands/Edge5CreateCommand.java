 ...
 * @generated
 */
public class Edge5CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge5CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4005(getContainer(),
                getSource(), getTarget());
    }
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        ElementInitializers.getInstance().init_Edge_4005(newElement);
