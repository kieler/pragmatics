 ...
 * @generated
 */
public class Edge3CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge3CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        if (source != null && false == source instanceof KPort) {
            return false;
        }
        if (target != null && false == target instanceof KPort) {
            return false;
        }
        if (getSource() == null) {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4003(getContainer(),
                getSource(), getTarget());
    }
