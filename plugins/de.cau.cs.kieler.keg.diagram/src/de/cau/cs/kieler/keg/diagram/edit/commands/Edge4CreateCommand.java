 ...
 * @generated
 */
public class Edge4CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge4CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4004(getContainer(),
                getSource(), getTarget());
    }
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        ElementInitializers.getInstance().init_Edge_4004(newElement);
