 ...
 * @generated
 */
public class Edge6CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge6CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4006(getContainer(),
                getSource(), getTarget());
    }
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        ElementInitializers.getInstance().init_Edge_4006(newElement);
