 ...
 * @generated
 */
public class Edge8CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge8CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints().canCreateEdge_4008(getContainer(),
                getSource(), getTarget());
    }
    ...
    protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
        ...
        ElementInitializers.getInstance().init_Edge_4008(newElement);
