...
public class NoServiceObjectException extends RuntimeException {
     ...
     *
     */
    private static final long serialVersionUID = -3874636137892340506L;

    /**
     * Default constructor.
     */
    public NoServiceObjectException() {
        super();
    }
     ...
     */
    public NoServiceObjectException(final Throwable throwable) {
        super(throwable);
    }
