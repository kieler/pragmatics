 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getId <em>Id</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getAppliesTo <em>Applies To</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getDefault <em>Default</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#isAdvanced <em>Advanced</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getRemoteEnum <em>Remote Enum</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kwebs.server.servicedata.impl.LayoutOptionImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
