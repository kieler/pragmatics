    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(de.cau.cs.kieler.kwebs.server.jaxws.LayoutService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = de.cau.cs.kieler.kwebs.server.jaxws.LayoutService.class.getResource(".");
