...
public class ServiceDataProvider implements IDynamicWebContentProvider {
    ...
    /** The cached generated HTML representation of the services meta data. */
    private byte[] serviceDataAsHtml
        = null;
    
    /**
     * Returns the generated HTML representation ot the service meta data.
     */
    private void generateHtml() {    
        
        ServiceData serviceData = ServerLayoutDataService.getInstance().getServiceDataModel();
        ...
        serviceDataAsHtml = sb.toString().getBytes();
    ...
    public void handleRequest(final RequestData requestData) {
        if (serviceDataAsHtml == null) {
            generateHtml();
        }
        requestData.setContent(serviceDataAsHtml);
    }
