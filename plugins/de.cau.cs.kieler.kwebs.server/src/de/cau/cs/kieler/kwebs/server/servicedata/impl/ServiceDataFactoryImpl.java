...
import de.cau.cs.kieler.kwebs.server.servicedata.*;
...
public class ServiceDataFactoryImpl extends EFactoryImpl implements ServiceDataFactory {
    ...
    public static ServiceDataFactory init() {
        try {
            ServiceDataFactory theServiceDataFactory = (ServiceDataFactory)EPackage.Registry.INSTANCE.getEFactory(ServiceDataPackage.eNS_URI);
