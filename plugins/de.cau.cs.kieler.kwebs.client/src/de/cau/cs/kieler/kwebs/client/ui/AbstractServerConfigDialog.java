...
import de.cau.cs.kieler.kwebs.client.ServerConfigs.ServerConfigError;
...
//        );
    ...
    protected void buttonPressed(final int buttonId) {
        if (buttonId == IDialogConstants.OK_ID) {
            ...
            ServerConfigData updatedServerConfig = ServerConfigs.getInstance().createServerConfig(
     ...
     *         exists in the server configuration list
     */
    protected abstract boolean warningOnDouble(final ServerConfigData theserverConfig);
     ...
     *         resembles an invalid server configuration
     */
    protected abstract boolean warningOnInvalid(final ServerConfigData theserverConfig);
     ...
     */
    protected abstract void handleServerConfigUpdate(final ServerConfigData updatedServerConfig);
    ...
    protected final void checkAvailability() {
        ServerConfigData serverConfig = ServerConfigs.getInstance().createServerConfig(
            getName(), getAddress(), getTruststore(), getTruststorePass()
        );
