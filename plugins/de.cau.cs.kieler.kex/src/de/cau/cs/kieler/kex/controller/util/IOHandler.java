...
public class IOHandler {
    ...
    public static File filterPluginXML(final File location) throws KielerException {
        ...
        File project = searchUP(location, IOHandler.PROJECT_FILE).getParentFile();
        if (project == null) {
     ...
     * @throws IOException
     */
    public static void writeFile(final URL sourceUrl, final String destPath, final boolean overwrite)
            throws IOException {
