 ...
 * @generated
 */
public class KDiagramSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        DiagramSynthesis diagramSynthesis = (DiagramSynthesis)theEObject;
        T result = caseDiagramSynthesis(diagramSynthesis);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Diagram Synthesis</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Diagram Synthesis</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDiagramSynthesis(DiagramSynthesis object)
  {
    return null;
  }
