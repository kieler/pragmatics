package de.cau.cs.kieler.klighd.kdiagram.serializer;
...
public class KDiagramSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private KDiagramGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == KDiagramPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case KDiagramPackage.DIAGRAM_SYNTHESIS:
				if(context == grammarAccess.getDiagramSynthesisRule()) {
					sequence_DiagramSynthesis(context, (DiagramSynthesis) semanticObject); 
					return; 
				}
				else break;
			case KDiagramPackage.EDGE_MAPPING:
				if(context == grammarAccess.getEdgeMappingRule()) {
					sequence_EdgeMapping(context, (EdgeMapping) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (name=ID elements=XExpression from=XExpression to=XExpression figureType=[JvmType|QualifiedName])
	 */
	protected void sequence_EdgeMapping(EObject context, EdgeMapping semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__NAME));
			if(transientValues.isValueTransient(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__ELEMENTS) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__ELEMENTS));
			if(transientValues.isValueTransient(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__FROM) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__FROM));
			if(transientValues.isValueTransient(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__TO) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__TO));
			if(transientValues.isValueTransient(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__FIGURE_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KDiagramPackage.Literals.EDGE_MAPPING__FIGURE_TYPE));
		}
