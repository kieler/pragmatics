...
import de.cau.cs.kieler.kiml.graphviz.dot.CompassPoint;
import de.cau.cs.kieler.kiml.graphviz.dot.DotFactory;
import de.cau.cs.kieler.kiml.graphviz.dot.DotPackage;
import de.cau.cs.kieler.kiml.graphviz.dot.EdgeOperator;
...
import de.cau.cs.kieler.kiml.graphviz.dot.Port;
...
public class DotPackageImpl extends EPackageImpl implements DotPackage
{
   ...
   * @see de.cau.cs.kieler.kiml.graphviz.dot.DotPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EReference getEdgeStatement_SourceSubgraph()
  {
  ...
  {
    return (EReference)edgeStatementEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getAttributeList_Entries()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(edgeStatementEClass, EDGE_STATEMENT__SOURCE_SUBGRAPH);
    ...
    createEReference(attributeListEClass, ATTRIBUTE_LIST__ENTRIES);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getEdgeStatement_SourceSubgraph(), this.getSubgraph(), null, "sourceSubgraph", null, 0, 1, EdgeStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEdgeStatement_Attributes(), this.getAttributeList(), null, "attributes", null, 0, 1, EdgeStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getNodeStatement_Attributes(), this.getAttributeList(), null, "attributes", null, 0, 1, NodeStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAttributeStatement_Attributes(), this.getAttributeList(), null, "attributes", null, 0, 1, AttributeStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAttributeList_Entries(), this.getAttribute(), null, "entries", null, 0, -1, AttributeList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    addEEnumLiteral(compassPointEEnum, CompassPoint.NORTHEAST);
    addEEnumLiteral(compassPointEEnum, CompassPoint.EAST);
    addEEnumLiteral(compassPointEEnum, CompassPoint.SOUTHEAST);
    addEEnumLiteral(compassPointEEnum, CompassPoint.SOUTH);
    addEEnumLiteral(compassPointEEnum, CompassPoint.SOUTHWEST);
    addEEnumLiteral(compassPointEEnum, CompassPoint.WEST);
    addEEnumLiteral(compassPointEEnum, CompassPoint.NORTHWEST);
