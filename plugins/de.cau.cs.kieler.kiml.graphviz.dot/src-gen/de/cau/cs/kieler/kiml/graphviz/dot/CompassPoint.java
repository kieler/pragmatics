 ...
 * <!-- end-user-doc -->
 * @see de.cau.cs.kieler.kiml.graphviz.dot.DotPackage#getCompassPoint()
 * @model
 * @generated
 */
public enum CompassPoint implements Enumerator
{
   ...
   * @ordered
   */
  public static final int SOUTHEAST_VALUE = 3;
