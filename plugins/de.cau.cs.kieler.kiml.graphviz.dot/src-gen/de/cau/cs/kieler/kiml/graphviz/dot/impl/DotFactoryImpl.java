...
public class DotFactoryImpl extends EFactoryImpl implements DotFactory
{
  ...
  public static DotFactory init()
  {
    try
    {
      DotFactory theDotFactory = (DotFactory)EPackage.Registry.INSTANCE.getEFactory("http://kieler.cs.cau.de/Dot"); 
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case DotPackage.ATTRIBUTE_LIST: return createAttributeList();
