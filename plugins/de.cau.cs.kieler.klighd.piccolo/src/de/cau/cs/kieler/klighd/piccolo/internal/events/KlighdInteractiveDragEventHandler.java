 ...
 * @author chsch
 */
public class KlighdInteractiveDragEventHandler extends PDragEventHandler {
     ...
     * Constructor.
     *
     * @param pViewer the {@link PiccoloViewer} this handler is attached to
     */
    ...
    protected boolean shouldStartDragInteraction(final PInputEvent event) {
            return event.isShiftDown() && super.shouldStartDragInteraction(event);
    }
    ...
    protected void startDrag(final PInputEvent event) {
            ...
            final PAffineTransform invertedNodeNodeTransform = new PAffineTransform(
                            NodeUtil.invert(nodeNode.getTransformReference(true)));
