    ...
    public Object execute(final ExecutionEvent event) throws ExecutionException {
        ...
        if (selection instanceof ITextSelection) {
            ...
            IDiagramWorkbenchPart diagramPart = DiagramViewManager.createView(
                    "de.cau.cs.kieler.uml.sequence.klighd.SequenceDiagramDiagram", "SequenceDiagram Diagram",
            ...
            DiagramViewManager.createView(
                    "de.cau.cs.kieler.uml.sequence.klighd.SequenceDiagramDiagram", "SequenceDiagram Diagram", model);
        } else {
