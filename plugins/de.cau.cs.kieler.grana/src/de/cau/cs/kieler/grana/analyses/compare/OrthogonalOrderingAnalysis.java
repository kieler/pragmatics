...
import static de.cau.cs.kieler.grana.analyses.compare.PointSetUtils.center;
...
public class OrthogonalOrderingAnalysis implements IComparingAnalysis {
    ...
    public static final String ID = "de.cau.cs.kieler.grana.compare.orthogonalOrdering";
