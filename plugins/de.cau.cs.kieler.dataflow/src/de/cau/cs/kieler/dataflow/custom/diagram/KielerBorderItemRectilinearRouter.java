...
public class KielerBorderItemRectilinearRouter extends
    ...
    protected PointList calculateBendPoints(Connection conn) {
        ...
        myAvoidOverlappingWithParent(startPoint, endPoint, sourceParentRect,
    ...
    protected int getBorderFigurePosition(IFigure borderFigure) {
        ...
        if(parent instanceof BorderedNodeFigure){
        	child = parent;   // child needs to be the wrapping BorderedNodeFigure of the borderFigure
        	parent = child.getParent(); // parent is the outer BorderItemContainerFigure
        }
        // fix end
    ...
    private void myAvoidOverlappingWithParent(AbsoluteBendpoint startPoint,
            AbsoluteBendpoint endPoint, Rectangle sourceParentRect,
            Rectangle targetParentRect, List constraint, Connection conn) {
        if (sourceParentRect.intersects(targetParentRect)) {
            return;
