...
public interface GlobalOutputRef extends EObject
{
   ...
   * @see #setName(String)
   * @see de.cau.cs.kieler.kiml.grana.text.grana.GranaPackage#getGlobalOutputRef_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kiml.grana.text.grana.GlobalOutputRef#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kiml.grana.text.grana.GranaPackage#getGlobalOutputRef_Output()
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kiml.grana.text.grana.GlobalOutputRef#getOutput <em>Output</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
