 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kiml.grana.text.grana.RangeJob#isMeasureExecutionTime <em>Measure Execution Time</em>}</li>
 ...
 *   <li>{@link de.cau.cs.kieler.kiml.grana.text.grana.RangeJob#getRangeAnalyses <em>Range Analyses</em>}</li>
 * </ul>
 *
...
public interface RangeJob extends Job
{
   ...
   * @see de.cau.cs.kieler.kiml.grana.text.grana.GranaPackage#getRangeJob_MeasureExecutionTime()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.cau.cs.kieler.kiml.grana.text.grana.RangeJob#isMeasureExecutionTime <em>Measure Execution Time</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.cau.cs.kieler.kiml.grana.text.grana.GranaPackage#getRangeJob_RangeAnalyses()
   * @model containment="true"
   * @generated
   */
