...
import de.cau.cs.kieler.dataflow.diagram.edit.policies.OutputPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPortEditPart extends BorderedBorderItemEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OutputPortItemSemanticEditPolicy());
    ...
    protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
        if (borderItemEditPart instanceof OutputPortNameEditPart) {
    ...
    public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
        ...
        if (targetEditPart instanceof de.cau.cs.kieler.dataflow.diagram.edit.parts.OutputPortEditPart) {
            types.add(DataflowElementTypes.Connection_4001);
        }
        return types;
    }
