 ...
 * @generated
 */
public class BoxNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public BoxNameEditPart(View view) {
        super(view);
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = DataflowParserProvider
                    .getParser(
                            DataflowElementTypes.Box_2001,
                            getParserElement(),
                            DataflowVisualIDRegistry
                                    .getType(de.cau.cs.kieler.dataflow.diagram.edit.parts.BoxNameEditPart.VISUAL_ID));
        }
        return parser;
    }
