...
import de.cau.cs.kieler.dataflow.diagram.edit.policies.DataflowTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BoxName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
     ...
     * @generated
     */
    public BoxName2EditPart(View view) {
        super(view);
    }
    ...
    public void setLabelText(String text) {
        ...
        if (pdEditPolicy instanceof DataflowTextSelectionEditPolicy) {
            ((DataflowTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
        }
        Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
        if (sfEditPolicy instanceof DataflowTextSelectionEditPolicy) {
            ((DataflowTextSelectionEditPolicy) sfEditPolicy).refreshFeedback();
        }
    }
    ...
    public IParser getParser() {
        if (parser == null) {
            parser = DataflowParserProvider
                    .getParser(
                            DataflowElementTypes.Box_3003,
                            getParserElement(),
                            DataflowVisualIDRegistry
                                    .getType(de.cau.cs.kieler.dataflow.diagram.edit.parts.BoxName2EditPart.VISUAL_ID));
        }
        return parser;
    }
    ...
    protected DirectEditManager getManager() {
        if (manager == null) {
            setManager(new TextDirectEditManager(this, TextDirectEditManager
                    .getTextCellEditorClass(this), DataflowEditPartFactory
