 ...
 * @generated
 */
public abstract class DataflowAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = DataflowDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected DataflowAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
