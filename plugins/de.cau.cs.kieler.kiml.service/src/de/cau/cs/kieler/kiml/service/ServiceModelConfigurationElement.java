 ...
 * @author swe
 */
public class ServiceModelConfigurationElement implements IConfigurationElement {
     ...
     * @param thename
     */
    public ServiceModelConfigurationElement(final String thename) {
        name = thename;
    }
     ...
     * @param thevalue
     */
    public ServiceModelConfigurationElement(final String thename, final String thevalue) {
        name = thename;
        value = thevalue;
    }
     ...
     * @return
     */
    public static ServiceModelConfigurationElement getCategoryElementFromModel(final Category category) {
        ServiceModelConfigurationElement element = new ServiceModelConfigurationElement(
     ...
     * @return
     */
    public static ServiceModelConfigurationElement getLayoutTypeElementFromModel(final LayoutType type) {
        ServiceModelConfigurationElement element = new ServiceModelConfigurationElement(
     ...
     * @return
     */
    public static ServiceModelConfigurationElement getLayoutOptionElementFromModel(final LayoutOption option) {
        ServiceModelConfigurationElement element = new ServiceModelConfigurationElement(
     ...
     * @return
     */
    public static ServiceModelConfigurationElement getLayoutAlgorithmElementFromModel(final LayoutAlgorithm algorithm) {
        ServiceModelConfigurationElement element = new ServiceModelConfigurationElement(
        ...
        for (KnownOption option : algorithm.getKnownOptions()) {
            ServiceModelConfigurationElement subElement
                = new ServiceModelConfigurationElement(ExtensionLayoutDataService.ELEMENT_KNOWN_OPTION);
        ...
        for (SupportedDiagram diagram : algorithm.getSupportedDiagrams()) {
            ServiceModelConfigurationElement subElement = new ServiceModelConfigurationElement(
