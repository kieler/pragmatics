 ...
 * <ul>
 *   <li>{@link ptolemy.Moml.PortType#getGroup <em>Group</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getConfigure <em>Configure</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getDoc <em>Doc</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getProperty <em>Property</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getRename <em>Rename</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getClass_ <em>Class</em>}</li>
 *   <li>{@link ptolemy.Moml.PortType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see ptolemy.Moml.MomlPackage#getPortType()
...
public interface PortType extends EObject {
     ...
     * @see ptolemy.Moml.MomlPackage#getPortType_Group()
     ...
     * @see ptolemy.Moml.MomlPackage#getPortType_Configure()
     ...
     * @see ptolemy.Moml.MomlPackage#getPortType_Doc()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see ptolemy.Moml.MomlPackage#getPortType_Property()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see ptolemy.Moml.MomlPackage#getPortType_Rename()
     * @model containment="true" transient="true" volatile="true" derived="true"
     ...
     * @see #setClass(String)
     * @see ptolemy.Moml.MomlPackage#getPortType_Class()
    ...
    /**
     * Sets the value of the '{@link ptolemy.Moml.PortType#getClass_ <em>Class</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * @see #setName(String)
     * @see ptolemy.Moml.MomlPackage#getPortType_Name()
     * @model required="true"
    ...
    /**
     * Sets the value of the '{@link ptolemy.Moml.PortType#getName <em>Name</em>}' attribute.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
