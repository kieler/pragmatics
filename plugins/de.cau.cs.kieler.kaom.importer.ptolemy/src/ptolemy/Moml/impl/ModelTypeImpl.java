 ...
 * <ul>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getConfigure <em>Configure</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getDeleteEntity <em>Delete Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getDeletePort <em>Delete Port</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getDeleteRelation <em>Delete Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getDirector <em>Director</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getImport <em>Import</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getRename <em>Rename</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getRendition <em>Rendition</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getUnlink <em>Unlink</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getClass1 <em>Class1</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ModelTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
