...
import ptolemy.Moml.ClassType;
import ptolemy.Moml.ConfigureType;
import ptolemy.Moml.DeleteEntityType;
import ptolemy.Moml.DeletePortType;
import ptolemy.Moml.DeletePropertyType;
import ptolemy.Moml.DeleteRelationType;
import ptolemy.Moml.DirectorType;
import ptolemy.Moml.DocType;
import ptolemy.Moml.DocumentRoot;
import ptolemy.Moml.EntityType;
import ptolemy.Moml.GroupType;
import ptolemy.Moml.ImportType;
import ptolemy.Moml.InputType;
import ptolemy.Moml.LinkType;
import ptolemy.Moml.LocationType;
import ptolemy.Moml.ModelType;
import ptolemy.Moml.MomlPackage;
import ptolemy.Moml.PortType;
import ptolemy.Moml.PropertyType;
import ptolemy.Moml.RelationType;
import ptolemy.Moml.RenameType;
import ptolemy.Moml.RenditionType;
import ptolemy.Moml.UnlinkType;
import ptolemy.Moml.VertexType;
 ...
 * <ul>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getConfigure <em>Configure</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDeleteEntity <em>Delete Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDeletePort <em>Delete Port</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDeleteProperty <em>Delete Property</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDeleteRelation <em>Delete Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDirector <em>Director</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getImport <em>Import</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getInput <em>Input</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getLink <em>Link</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getModel <em>Model</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getPort <em>Port</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getRename <em>Rename</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getRendition <em>Rendition</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getUnlink <em>Unlink</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.DocumentRootImpl#getVertex <em>Vertex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
