 ...
 * <ul>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getConfigure <em>Configure</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getDeleteEntity <em>Delete Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getDeletePort <em>Delete Port</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getDeleteRelation <em>Delete Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getDirector <em>Director</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getDoc <em>Doc</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getImport <em>Import</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getInput <em>Input</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getLink <em>Link</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getPort <em>Port</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getProperty <em>Property</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getRename <em>Rename</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getRendition <em>Rendition</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getUnlink <em>Unlink</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getExtends <em>Extends</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link ptolemy.Moml.impl.ClassTypeImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
