...
public final class KCustomRenderingWrapperFactory {
    ...
    private KCustomRenderingWrapperFactory() {
        ...
        for (final IConfigurationElement element : wrappers) {
            ...
            try {
                ...
                StatusHandler.handle(new Status(IStatus.ERROR, KlighdPlugin.PLUGIN_ID, msg, e), StatusHandler.LOG);
    ...
    public <T> T getWrapperInstance(final String bundleName, final String renderingTypeName,
        ...
        if (Strings.isNullOrEmpty(renderingTypeName)) {
            ...
            StatusHandler.handle(new Status(IStatus.ERROR, KlighdPlugin.PLUGIN_ID, msg), StatusHandler.LOG);
            return null;
        }
    ...
    public <S, T> T getWrapperInstance(final Class<S> renderingType, final Class<T> frameworkType) {
        ...
        try {
            ...
            StatusHandler.handle(
                    new Status(IStatus.ERROR, KlighdPlugin.PLUGIN_ID, msg, e), StatusHandler.LOG);
            return null;
        }
