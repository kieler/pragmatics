...
import de.cau.cs.kieler.kiml.service.DiagramLayoutEngine.ILayoutCancelationHandle;
...
public final class LightDiagramServices {
    ...
    private static void layoutDiagram(final IDiagramWorkbenchPart workbenchPart,
        ...
        if (layoutData != null) {
            ...
            final ILayoutCancelationHandle cancelationHandle = thePart != null
                    ? new DispositionAwareCancelationHandle(thePart) : null;

            if (additionalConfigs.isEmpty()) {
                DiagramLayoutEngine.INSTANCE.layout(thePart, diagramPart, cancelationHandle,
                        extendedOptions);
    ...
    /**
     * An implementation of {@link ILayoutCancelationHandle} checking the provided
     ...
     * @author chsch
     */
    private static final class DispositionAwareCancelationHandle implements ILayoutCancelationHandle {
