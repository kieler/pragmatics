 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kiml.layout.klayoutdata.impl.KStringOptionImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class KStringOptionImpl extends KOptionImpl implements KStringOption {
    ...
    protected EClass eStaticClass() {
        return KLayoutDataPackage.Literals.KSTRING_OPTION;
    }
    ...
    public void setValue(String newValue) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KLayoutDataPackage.KSTRING_OPTION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case KLayoutDataPackage.KSTRING_OPTION__VALUE:
                return getValue();
        }
