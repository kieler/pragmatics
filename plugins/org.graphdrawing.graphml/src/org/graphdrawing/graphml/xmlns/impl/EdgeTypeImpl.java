 ...
 * <ul>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getGraph <em>Graph</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#isDirected <em>Directed</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getSourceport <em>Sourceport</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getTargetport <em>Targetport</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EdgeTypeImpl extends EObjectImpl implements EdgeType {
	...
	protected EClass eStaticClass() {
		return XmlnsPackage.Literals.EDGE_TYPE;
	}
	...
	public void setDesc(String newDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__DESC, oldDesc, desc));
	}
	...
	public EList<DataType> getData() {
		if (data == null) {
			data = new EObjectContainmentEList<DataType>(DataType.class, this, XmlnsPackage.EDGE_TYPE__DATA);
		}
		return data;
	}
	...
	public NotificationChain basicSetGraph(GraphType newGraph, NotificationChain msgs) {
		...
		graph = newGraph;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__GRAPH, oldGraph, newGraph);
	...
	public void setGraph(GraphType newGraph) {
		if (newGraph != graph) {
			...
			if (graph != null)
				msgs = ((InternalEObject)graph).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmlnsPackage.EDGE_TYPE__GRAPH, null, msgs);
			if (newGraph != null)
				msgs = ((InternalEObject)newGraph).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmlnsPackage.EDGE_TYPE__GRAPH, null, msgs);
			msgs = basicSetGraph(newGraph, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__GRAPH, newGraph, newGraph));
	}
	...
	public void setDirected(boolean newDirected) {
		...
		directedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__DIRECTED, oldDirected, directed, !oldDirectedESet));
	}
	...
	public void unsetDirected() {
		...
		directedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlnsPackage.EDGE_TYPE__DIRECTED, oldDirected, DIRECTED_EDEFAULT, oldDirectedESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__ID, oldId, id));
	}
	...
	public void setSource(String newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__SOURCE, oldSource, source));
	}
	...
	public void setSourceport(String newSourceport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__SOURCEPORT, oldSourceport, sourceport));
	}
	...
	public void setTarget(String newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__TARGET, oldTarget, target));
	}
	...
	public void setTargetport(String newTargetport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__TARGETPORT, oldTargetport, targetport));
	}
