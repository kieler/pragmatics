 ...
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.KeyTypeImpl#isDynamic <em>Dynamic</em>}</li>
...
public class KeyTypeImpl extends EObjectImpl implements KeyType {
	...
	public void setDynamic(boolean newDynamic) {
		...
		dynamicESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.KEY_TYPE__DYNAMIC, oldDynamic, dynamic, !oldDynamicESet));
	}
	...
	public void unsetDynamic() {
		...
		dynamicESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XmlnsPackage.KEY_TYPE__DYNAMIC, oldDynamic, DYNAMIC_EDEFAULT, oldDynamicESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XmlnsPackage.KEY_TYPE__ATTR_TYPE:
				return getAttrType();
			case XmlnsPackage.KEY_TYPE__DYNAMIC:
				return isDynamic();
