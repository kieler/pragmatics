 ...
 *   <li>{@link org.graphdrawing.graphml.impl.PortTypeImpl#getData <em>Data</em>}</li>
...
public class PortTypeImpl extends EObjectImpl implements PortType {
    ...
    protected EClass eStaticClass() {
        return GraphMLPackage.Literals.PORT_TYPE;
    }
    ...
    public void setDesc(String newDesc) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.PORT_TYPE__DESC, oldDesc, desc));
    }
    ...
    public FeatureMap getGroup() {
        if (group == null) {
            group = new BasicFeatureMap(this, GraphMLPackage.PORT_TYPE__GROUP);
        }
        return group;
    }
    ...
    public EList<DataType> getData() {
        return getGroup().list(GraphMLPackage.Literals.PORT_TYPE__DATA);
    }
    ...
    public EList<PortType> getPort() {
        return getGroup().list(GraphMLPackage.Literals.PORT_TYPE__PORT);
    }
    ...
    public void setName(String newName) {
        ...
        name = newName;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.PORT_TYPE__NAME, oldName, name));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case GraphMLPackage.PORT_TYPE__GROUP:
                return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
            case GraphMLPackage.PORT_TYPE__DATA:
                return ((InternalEList<?>)getData()).basicRemove(otherEnd, msgs);
            case GraphMLPackage.PORT_TYPE__PORT:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case GraphMLPackage.PORT_TYPE__DESC:
                return getDesc();
            case GraphMLPackage.PORT_TYPE__GROUP:
            ...
            case GraphMLPackage.PORT_TYPE__PORT:
                return getPort();
            case GraphMLPackage.PORT_TYPE__NAME:
                return getName();
        }
