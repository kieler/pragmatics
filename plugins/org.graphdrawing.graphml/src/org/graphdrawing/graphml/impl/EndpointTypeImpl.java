 ...
 *   <li>{@link org.graphdrawing.graphml.impl.EndpointTypeImpl#getNode <em>Node</em>}</li>
...
public class EndpointTypeImpl extends EObjectImpl implements EndpointType {
    ...
    public void setDesc(String newDesc) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.ENDPOINT_TYPE__DESC, oldDesc, desc));
    }
    ...
    public void setId(String newId) {
        ...
        id = newId;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.ENDPOINT_TYPE__ID, oldId, id));
    }
    ...
    public void setNode(String newNode) {
        ...
        node = newNode;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.ENDPOINT_TYPE__NODE, oldNode, node));
    }
    ...
    public void setPort(String newPort) {
        ...
        port = newPort;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.ENDPOINT_TYPE__PORT, oldPort, port));
    }
    ...
    public void setType(EndpointTypeType newType) {
        ...
        typeESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, GraphMLPackage.ENDPOINT_TYPE__TYPE, oldType, type, !oldTypeESet));
    }
    ...
    public void unsetType() {
        ...
        typeESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, GraphMLPackage.ENDPOINT_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case GraphMLPackage.ENDPOINT_TYPE__DESC:
                return getDesc();
            case GraphMLPackage.ENDPOINT_TYPE__ID:
                return getId();
            case GraphMLPackage.ENDPOINT_TYPE__NODE:
                return getNode();
            case GraphMLPackage.ENDPOINT_TYPE__PORT:
                return getPort();
            case GraphMLPackage.ENDPOINT_TYPE__TYPE:
                return getType();
        }
