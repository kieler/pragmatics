...
public class ImportExamplePage extends WizardResourceImportPage {
	...
	private void createBottomComponent(Composite parent) {
		...
		// }
		// FontData[] fontData =
		// this.exampleDescription.getFont().getFontData();
		// for (FontData fd : fontData) {
		//
		// int lfHeight = fd.data.lfHeight;
		// System.err.println(lfHeight);
		// }
		// this.exampleDescription.setFont(new Font(parent.getDisplay(),
		// fontData));
		// FontData[] fontData2 =
		// this.exampleDescription.getFont().getFontData();
		// for (FontData fd : fontData) {
	...
	private Control createTree(Composite composite, Control topControl) {
		...
		// if categoriesize null wizard close and errormessage
	...
	private void updateDescriptionLabel(Example selectedExample) {
		...
		sb.append("Title:       ").append(selectedExample.getTitle())
				.append("<br>").append("Author:   ")
				.append(selectedExample.getAuthor()).append("<br>")
