...
public class ProjectImportPage extends WizardResourceImportPage implements Listener {
    ...
    public ProjectImportPage(String name, IWorkbench aWorkbench, IStructuredSelection selection) {
    ...
    protected final void createButtonsGroup(Composite parent) {
        ...
        selectAllButton = createButton(buttonComposite, IDialogConstants.SELECT_ALL_ID,
                SELECT_ALL_TITLE, false);
        ...
        deselectAllButton = createButton(buttonComposite, IDialogConstants.DESELECT_ALL_ID,
    ...
    protected void createRootDirectoryGroup(Composite parent) {
        ...
        sourceContainerGroup.setLayoutData(new GridData(GridData.HORIZONTAL_ALIGN_FILL
    ...
    protected MinimizedFileSystemElement createRootElement(Object fileSystemObject,
        ...
        MinimizedFileSystemElement result = new MinimizedFileSystemElement(elementLabel,
                dummyParent, isContainer);
    ...
    protected boolean executeImportOperation(ImportOperation op) {
        ...
        if (!status.isOK()) {
            ErrorDialog.openError(getContainer().getShell(),
                    DataTransferMessages.FileImport_importProblems, null, // no special message
                    status);
            return false;
        }
    ...
    /**
     * Returns a content provider for <code>FileSystemElement</code>s that returns only folders as
     * children.
     */
    @Override
    ...
    protected boolean importResources(List fileSystemObjects) {
        ImportOperation operation = new ImportOperation(getContainerFullPath(),
                getSourceDirectory(), fileSystemStructureProvider, this, fileSystemObjects);
    ...
    protected void saveWidgetValues() {
        ...
        if (settings != null) {
            ...
            // radio buttons and checkboxes
            settings.put(STORE_OVERWRITE_EXISTING_RESOURCES_ID, overwriteExistingResourcesCheckbox
                    .getSelection());

            settings.put(STORE_CREATE_CONTAINER_STRUCTURE_ID, createContainerStructureButton
                    .getSelection());
    ...
    protected void setupSelectionsBasedOnSelectedTypes() {
        ...
        final IElementFilter filter = new IElementFilter() {
            ...
            public void filterElements(Collection files, IProgressMonitor monitor)
        ...
        IRunnableWithProgress runnable = new IRunnableWithProgress() {
            public void run(final IProgressMonitor monitor) throws InterruptedException {
                monitor.beginTask(DataTransferMessages.ImportPage_filterSelections,
