...
public class GradientCanvas extends Canvas {
    ...
    private void updateGradientImage() {
        ...
        if (gradientInfo != null) {
            ...
            // gradientInfo.vertical ? rect.height : rect.width, gradientInfo.vertical,
            // getColor(COLOR_BASE_BG));
            ...
            gradientImage = new Image(getDisplay(), Math.max(rect.width, 1), Math.max(rect.height,
                    1));
