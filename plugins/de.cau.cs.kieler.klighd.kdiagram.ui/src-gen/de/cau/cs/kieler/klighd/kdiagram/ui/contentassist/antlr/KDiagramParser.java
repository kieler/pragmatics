...
* generated by Xtext
*/
package de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr;
...
public class KDiagramParser extends AbstractContentAssistParser {
	...
	@Override
	protected de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr.internal.InternalKDiagramParser createParser() {
		de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr.internal.InternalKDiagramParser result = new de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr.internal.InternalKDiagramParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getMappingDefinitionAccess().getAlternatives_4(), "rule__MappingDefinition__Alternatives_4");
					...
					put(grammarAccess.getDiagramSynthesisAccess().getGroup(), "rule__DiagramSynthesis__Group__0");
					put(grammarAccess.getDiagramSynthesisAccess().getGroup_0(), "rule__DiagramSynthesis__Group_0__0");
					put(grammarAccess.getMappingDefinitionAccess().getGroup(), "rule__MappingDefinition__Group__0");
					put(grammarAccess.getNodeMappingAccess().getGroup(), "rule__NodeMapping__Group__0");
					put(grammarAccess.getNodeMappingAccess().getGroup_5_0(), "rule__NodeMapping__Group_5_0__0");
					put(grammarAccess.getNodeMappingAccess().getGroup_5_0_2(), "rule__NodeMapping__Group_5_0_2__0");
					put(grammarAccess.getNodeMappingAccess().getGroup_5_1(), "rule__NodeMapping__Group_5_1__0");
					put(grammarAccess.getPortMappingAccess().getGroup(), "rule__PortMapping__Group__0");
					put(grammarAccess.getPortMappingAccess().getGroup_9_0(), "rule__PortMapping__Group_9_0__0");
					put(grammarAccess.getPortMappingAccess().getGroup_9_0_2(), "rule__PortMapping__Group_9_0_2__0");
					put(grammarAccess.getPortMappingAccess().getGroup_9_1(), "rule__PortMapping__Group_9_1__0");
					put(grammarAccess.getEdgeMappingAccess().getGroup(), "rule__EdgeMapping__Group__0");
					put(grammarAccess.getEdgeMappingAccess().getGroup_5_0(), "rule__EdgeMapping__Group_5_0__0");
					put(grammarAccess.getEdgeMappingAccess().getGroup_5_1(), "rule__EdgeMapping__Group_5_1__0");
					...
					put(grammarAccess.getDiagramSynthesisAccess().getPackageNameAssignment_0_1(), "rule__DiagramSynthesis__PackageNameAssignment_0_1");
					put(grammarAccess.getDiagramSynthesisAccess().getImportSectionAssignment_1(), "rule__DiagramSynthesis__ImportSectionAssignment_1");
					put(grammarAccess.getDiagramSynthesisAccess().getNameAssignment_3(), "rule__DiagramSynthesis__NameAssignment_3");
					put(grammarAccess.getDiagramSynthesisAccess().getMappingAssignment_4(), "rule__DiagramSynthesis__MappingAssignment_4");
					put(grammarAccess.getMappingDefinitionAccess().getTypeAssignment_1(), "rule__MappingDefinition__TypeAssignment_1");
					put(grammarAccess.getMappingDefinitionAccess().getNameAssignment_2(), "rule__MappingDefinition__NameAssignment_2");
					put(grammarAccess.getMappingDefinitionAccess().getNodeMappingsAssignment_4_0(), "rule__MappingDefinition__NodeMappingsAssignment_4_0");
					put(grammarAccess.getMappingDefinitionAccess().getPortMappingsAssignment_4_1(), "rule__MappingDefinition__PortMappingsAssignment_4_1");
					put(grammarAccess.getMappingDefinitionAccess().getEdgeMappingsAssignment_4_2(), "rule__MappingDefinition__EdgeMappingsAssignment_4_2");
					put(grammarAccess.getNodeMappingAccess().getNameAssignment_1(), "rule__NodeMapping__NameAssignment_1");
					put(grammarAccess.getNodeMappingAccess().getElementsAssignment_3(), "rule__NodeMapping__ElementsAssignment_3");
					put(grammarAccess.getNodeMappingAccess().getWithPortsAssignment_5_0_1(), "rule__NodeMapping__WithPortsAssignment_5_0_1");
					put(grammarAccess.getNodeMappingAccess().getWithPortsAssignment_5_0_2_1(), "rule__NodeMapping__WithPortsAssignment_5_0_2_1");
					put(grammarAccess.getNodeMappingAccess().getFigureTypeAssignment_5_1_1(), "rule__NodeMapping__FigureTypeAssignment_5_1_1");
					put(grammarAccess.getNodeMappingAccess().getPortMappingsAssignment_5_2(), "rule__NodeMapping__PortMappingsAssignment_5_2");
					put(grammarAccess.getPortMappingAccess().getNameAssignment_1(), "rule__PortMapping__NameAssignment_1");
					put(grammarAccess.getPortMappingAccess().getNodeElementTypeAssignment_3(), "rule__PortMapping__NodeElementTypeAssignment_3");
					put(grammarAccess.getPortMappingAccess().getNodeElementNameAssignment_4(), "rule__PortMapping__NodeElementNameAssignment_4");
					put(grammarAccess.getPortMappingAccess().getElementsAssignment_7(), "rule__PortMapping__ElementsAssignment_7");
					put(grammarAccess.getPortMappingAccess().getIdentifiedByAssignment_9_0_1(), "rule__PortMapping__IdentifiedByAssignment_9_0_1");
					put(grammarAccess.getPortMappingAccess().getIndentifiedByAssignment_9_0_2_1(), "rule__PortMapping__IndentifiedByAssignment_9_0_2_1");
					put(grammarAccess.getPortMappingAccess().getFigureTypeAssignment_9_1_1(), "rule__PortMapping__FigureTypeAssignment_9_1_1");
					put(grammarAccess.getEdgeMappingAccess().getNameAssignment_1(), "rule__EdgeMapping__NameAssignment_1");
					put(grammarAccess.getEdgeMappingAccess().getElementsAssignment_3(), "rule__EdgeMapping__ElementsAssignment_3");
					put(grammarAccess.getEdgeMappingAccess().getFromAssignment_5_0_1(), "rule__EdgeMapping__FromAssignment_5_0_1");
					put(grammarAccess.getEdgeMappingAccess().getToAssignment_5_0_3(), "rule__EdgeMapping__ToAssignment_5_0_3");
					put(grammarAccess.getEdgeMappingAccess().getFigureTypeAssignment_5_1_1(), "rule__EdgeMapping__FigureTypeAssignment_5_1_1");
					...
					put(grammarAccess.getNodeMappingAccess().getUnorderedGroup_5(), "rule__NodeMapping__UnorderedGroup_5");
					put(grammarAccess.getPortMappingAccess().getUnorderedGroup_9(), "rule__PortMapping__UnorderedGroup_9");
					put(grammarAccess.getEdgeMappingAccess().getUnorderedGroup_5(), "rule__EdgeMapping__UnorderedGroup_5");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr.internal.InternalKDiagramParser typedParser = (de.cau.cs.kieler.klighd.kdiagram.ui.contentassist.antlr.internal.InternalKDiagramParser) parser;
			typedParser.entryRuleDiagramSynthesis();
