 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kaom.impl.NamedObjectImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedObjectImpl extends AnnotatableImpl implements NamedObject {
    ...
    protected EClass eStaticClass() {
        return KaomPackage.Literals.NAMED_OBJECT;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KaomPackage.NAMED_OBJECT__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case KaomPackage.NAMED_OBJECT__NAME:
                return getName();
        }
