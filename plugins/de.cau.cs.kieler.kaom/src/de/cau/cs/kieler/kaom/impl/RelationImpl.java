 ...
 *   <li>{@link de.cau.cs.kieler.kaom.impl.RelationImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationImpl extends NamedObjectImpl implements Relation {
    ...
    public void setId(String newId) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KaomPackage.RELATION__ID, oldId, id));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Linkable.class) {
            switch (derivedFeatureID) {
                ...
                case KaomPackage.RELATION__ID: return KaomPackage.LINKABLE__ID;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == Linkable.class) {
            switch (baseFeatureID) {
                ...
                case KaomPackage.LINKABLE__ID: return KaomPackage.RELATION__ID;
                default: return -1;
            }
        }
