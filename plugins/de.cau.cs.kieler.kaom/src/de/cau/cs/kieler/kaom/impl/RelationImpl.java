...
public class RelationImpl extends LinkableImpl implements Relation {
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, KaomPackage.RELATION__NAME, oldName, name));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == NamedObject.class) {
            switch (derivedFeatureID) {
                case KaomPackage.RELATION__NAME: return KaomPackage.NAMED_OBJECT__NAME;
                default: return -1;
            }
        }
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == NamedObject.class) {
            switch (baseFeatureID) {
                case KaomPackage.NAMED_OBJECT__NAME: return KaomPackage.RELATION__NAME;
                default: return -1;
            }
        }
