...
/**
 * Definition of available crossing minimization algorithms for the layered layouter.
 * 
 * @author msp
 */
public enum CrossingMinimization {
     ...
     */
    public static CrossingMinimization valueOf(final int i) {
        return values()[i];
    }
