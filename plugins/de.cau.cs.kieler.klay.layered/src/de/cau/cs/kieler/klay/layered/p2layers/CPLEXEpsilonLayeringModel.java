 ...
 * 
 */
public class CPLEXEpsilonLayeringModel extends AbstractCPLEXModel<Object, Pair<Integer, List<Integer>>> {
    ...
    public String serializeSourceModel(final Object source) {
        ...
        sb.append("\nw_length = " + layeredGraph.getProperty(Properties.EDGE_LENGTH_WEIGHT)
                ...
                + ";\nrev = " + layeredGraph.getProperty(InternalProperties.FAS_SIZE) 
                + ";\n");
//        
