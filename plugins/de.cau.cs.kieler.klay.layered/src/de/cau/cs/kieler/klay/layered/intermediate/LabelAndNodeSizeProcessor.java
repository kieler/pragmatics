...
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.GraphAdapter;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.GraphElementAdapter;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.LabelAdapter;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.NodeAdapter;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.PortAdapter;
import de.cau.cs.kieler.kiml.util.NodeSizeCalculation.SizeCalculationAdapterFactory;
...
public final class LabelAndNodeSizeProcessor implements ILayoutProcessor {
    ...
    public void process(final LGraph layeredGraph, final IKielerProgressMonitor monitor) {
        ...
        new NodeSizeCalculation().calculateNodeSizes(layeredGraph, new LGraphSizeCalculatorFactory());
        if (1==1) {
            return;
        }
    ...
    class LGraphSizeCalculatorFactory implements SizeCalculationAdapterFactory<LGraph> {
        /**
         * {@inheritDoc}
         */
        public GraphAdapter<LGraph> getGraphAdapter(final LGraph graph) {
            return new LGraphAdaptor(graph);
        }
    }

    class AbstractLGraphAdaptor<T extends LShape> implements GraphElementAdapter<T> {
     ...
     * 
     */
        public AbstractLGraphAdaptor(final T element) {
    ...
    class LGraphAdaptor implements GraphAdapter<LGraph> {
      ...
      * 
      */
        public LGraphAdaptor(final LGraph element) {
            this.element = element;
        }
    ...
    class LNodeAdapter extends AbstractLGraphAdaptor<LNode> implements NodeAdapter<LNode> {
    ...
    class LPortAdapter extends AbstractLGraphAdaptor<LPort> implements PortAdapter<LPort> {
    ...
    class LLabelAdapter extends AbstractLGraphAdaptor<LLabel> implements LabelAdapter<LLabel> {
