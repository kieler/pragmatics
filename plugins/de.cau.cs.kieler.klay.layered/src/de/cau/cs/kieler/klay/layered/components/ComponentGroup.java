...
public final class ComponentGroup {
    ...
    static {
        ...
        CONSTRAINTS.put(SIDES_EAST, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(SIDES_EAST_WEST, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(SIDES_NORTH_EAST, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(SIDES_EAST_SOUTH, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(SIDES_NORTH_EAST_WEST, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(SIDES_EAST_SOUTH_WEST, CONN_NORTH_EAST_SOUTH);
        ...
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_EAST);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_EAST_WEST);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_NORTH_EAST);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_EAST_SOUTH);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_NORTH_EAST_WEST);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, SIDES_EAST_SOUTH_WEST);
        CONSTRAINTS.put(CONN_NORTH_EAST_SOUTH, CONN_NORTH_EAST_SOUTH);
    }
