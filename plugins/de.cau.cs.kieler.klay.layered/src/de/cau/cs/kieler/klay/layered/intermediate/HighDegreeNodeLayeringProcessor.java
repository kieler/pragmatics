...
public class HighDegreeNodeLayeringProcessor implements ILayoutProcessor {
    ...
    public void process(final LGraph graph, final IKielerProgressMonitor progressMonitor) {
        ...
        int degreeThreshold = graph.getProperty(Properties.HIGHDEGREENODE_THRESHOLD);
        int treeHeightThreshold = graph.getProperty(Properties.HIGHDEGREENODE_TREEHEIGHT);
