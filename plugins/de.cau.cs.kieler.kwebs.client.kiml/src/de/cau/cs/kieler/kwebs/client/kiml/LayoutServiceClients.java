...
public final class LayoutServiceClients {
    ...
    private static final String EXTENSIONPOINT_ID
        = "de.cau.cs.kieler.kwebs.client.kiml.protocol.support";
     ...
     */
    public ILayoutServiceClient getClientForServerConfig(final ServerConfig serverConfig) {
     ...
     * @return the client compatible with the given protocol or {@code null}
     */
    public ILayoutServiceClient createClientForServerConfig(final ServerConfig serverConfig) {
        URI address = serverConfig.getAddress();
        String protocol = address.getScheme();
        if (protocol == null) {
            return null;
     ...
     */
    public boolean isServerConfigSupported(final ServerConfig serverConfig) {
        URI address = serverConfig.getAddress();
        String protocol = address.getScheme();
        if (protocol == null) {
            return false;
