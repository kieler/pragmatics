...
import de.cau.cs.rtprak.graphs.diagram.edit.policies.Node2ItemSemanticEditPolicy;
...
public class Node2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof NodeLabel2EditPart) {
			((NodeLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.cau.cs.rtprak.graphs.diagram.edit.parts.Node2EditPart) {
			types.add(GraphsElementTypes.Edge_4001);
		}
