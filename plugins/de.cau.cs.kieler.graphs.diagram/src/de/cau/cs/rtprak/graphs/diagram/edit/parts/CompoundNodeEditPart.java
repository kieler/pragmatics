...
import de.cau.cs.rtprak.graphs.diagram.edit.policies.CompoundNodeItemSemanticEditPolicy;
...
public class CompoundNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompoundNodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompoundNodeLabelEditPart) {
			((CompoundNodeLabelEditPart) childEditPart)
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.cau.cs.rtprak.graphs.diagram.edit.parts.CompoundNodeEditPart) {
			types.add(GraphsElementTypes.Edge_4001);
		}
