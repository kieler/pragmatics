...
import de.cau.cs.rtprak.graphs.diagram.expressions.GraphsAbstractExpression;
import de.cau.cs.rtprak.graphs.diagram.expressions.GraphsOCLFactory;
...
public class GraphsVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "de.cau.cs.rtprak.graphs.diagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getVisualID(View view) {
		...
		return de.cau.cs.rtprak.graphs.diagram.part.GraphsVisualIDRegistry
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (GraphsPackage.eINSTANCE.getGraph().isSuperTypeOf(
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = de.cau.cs.rtprak.graphs.diagram.part.GraphsVisualIDRegistry
		...
		if (GraphEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = de.cau.cs.rtprak.graphs.diagram.part.GraphsVisualIDRegistry
		...
		case CompoundNodeNodeCompartmentEditPart.VISUAL_ID:
			...
			if (GraphsPackage.eINSTANCE.getCompoundNode().isSuperTypeOf(
					domainElement.eClass())) {
