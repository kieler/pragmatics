...
import de.cau.cs.rtprak.graphs.diagram.part.GraphsDiagramUpdater;
import de.cau.cs.rtprak.graphs.diagram.part.GraphsLinkDescriptor;
import de.cau.cs.rtprak.graphs.diagram.part.GraphsNodeDescriptor;
...
public class GraphCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = GraphsDiagramUpdater.getGraph_1000SemanticChildren(
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case GraphEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GraphsDiagramUpdater
						.getGraph_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case CompoundNodeEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GraphsDiagramUpdater
						.getCompoundNode_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CompoundNode2EditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(GraphsDiagramUpdater
						.getCompoundNode_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
