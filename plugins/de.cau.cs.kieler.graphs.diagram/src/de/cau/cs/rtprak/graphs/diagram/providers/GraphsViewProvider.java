...
import de.cau.cs.rtprak.graphs.diagram.edit.parts.CompoundNodeLabel2EditPart;
import de.cau.cs.rtprak.graphs.diagram.edit.parts.CompoundNodeLabelEditPart;
...
import de.cau.cs.rtprak.graphs.diagram.edit.parts.EdgeLabelEditPart;
...
import de.cau.cs.rtprak.graphs.diagram.edit.parts.NodeLabel2EditPart;
import de.cau.cs.rtprak.graphs.diagram.edit.parts.NodeLabelEditPart;
...
public class GraphsViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return GraphEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!GraphEditPart.MODEL_ID.equals(GraphsVisualIDRegistry
		...
		return NodeEditPart.VISUAL_ID == visualID
				|| CompoundNodeEditPart.VISUAL_ID == visualID
				|| Node2EditPart.VISUAL_ID == visualID
				|| CompoundNode2EditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(GraphEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case CompoundNodeEditPart.VISUAL_ID:
			return createCompoundNode_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Node2EditPart.VISUAL_ID:
			return createNode_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CompoundNode2EditPart.VISUAL_ID:
			return createCompoundNode_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createNode_2001(EObject domainElement, View containerView,
		...
		node.setType(GraphsVisualIDRegistry.getType(NodeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createCompoundNode_2002(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GraphsVisualIDRegistry
		...
		createCompartment(node, GraphsVisualIDRegistry
				.getType(CompoundNodeNodeCompartmentEditPart.VISUAL_ID), true,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createCompoundNode_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
		...
		createCompartment(node, GraphsVisualIDRegistry
				.getType(CompoundNodeNodeCompartment2EditPart.VISUAL_ID), true,
				false, false, false);
		return node;
	}
