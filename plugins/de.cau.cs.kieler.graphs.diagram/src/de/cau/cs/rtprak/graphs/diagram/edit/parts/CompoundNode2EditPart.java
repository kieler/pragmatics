...
import de.cau.cs.rtprak.graphs.custom.NodeLayout;
import de.cau.cs.rtprak.graphs.diagram.edit.policies.CompoundNode2ItemSemanticEditPolicy;
...
public class CompoundNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CompoundNode2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CompoundNodeLabel2EditPart) {
			((CompoundNodeLabel2EditPart) childEditPart)
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof de.cau.cs.rtprak.graphs.diagram.edit.parts.CompoundNode2EditPart) {
			types.add(GraphsElementTypes.Edge_4001);
		}
		return types;
	}
