...
public class Edge4CreateCommand extends EditElementCommand {
     ...
     * @generated
     */
    public Edge4CreateCommand(CreateRelationshipRequest request,
    ...
    public boolean canExecute() {
        ...
        return GraphsBaseItemSemanticEditPolicy.getLinkConstraints()
                .canCreateEdge_4004(getContainer(), getSource(), getTarget());
    }
