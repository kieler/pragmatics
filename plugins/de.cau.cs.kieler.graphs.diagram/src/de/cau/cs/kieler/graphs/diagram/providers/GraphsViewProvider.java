...
public class GraphsViewProvider extends AbstractProvider implements IViewProvider {
    ...
    protected boolean provides(CreateNodeViewOperation op) {
        ...
        if (op.getSemanticHint() == null) {
            ...
            if (elementType != null) {
                ...
                if (!GraphEditPart.MODEL_ID.equals(GraphsVisualIDRegistry.getModelID(op
                        .getContainerView()))) {
        ...
        return NodeEditPart.VISUAL_ID == visualID || CompoundNodeEditPart.VISUAL_ID == visualID
                || Node2EditPart.VISUAL_ID == visualID || CompoundNode2EditPart.VISUAL_ID == visualID;
    }
    ...
    public Node createCompoundNode_2002(EObject domainElement, View containerView, int index,
        ...
        node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(GraphsVisualIDRegistry.getType(CompoundNodeEditPart.VISUAL_ID));
        ViewUtil.insertChildView(containerView, node, index, persisted);
        node.setElement(domainElement);
        stampShortcut(containerView, node);
        // initializeFromPreferences 
    ...
    public Node createCompoundNode_3002(EObject domainElement, View containerView, int index,
        ...
        node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
        node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
        node.setType(GraphsVisualIDRegistry.getType(CompoundNode2EditPart.VISUAL_ID));
        ViewUtil.insertChildView(containerView, node, index, persisted);
        node.setElement(domainElement);
        // initializeFromPreferences 
        final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
    ...
    private void stampShortcut(View containerView, Node target) {
        if (!GraphEditPart.MODEL_ID.equals(GraphsVisualIDRegistry.getModelID(containerView))) {
