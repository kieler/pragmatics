...
public class GraphsViewProvider extends AbstractProvider implements
    ...
    protected boolean provides(CreateNodeViewOperation op) {
        ...
        if (op.getSemanticHint() == null) {
            ...
            visualID =
                    GraphsVisualIDRegistry.getNodeVisualID(op
    ...
    public Node createNode(IAdaptable semanticAdapter, View containerView,
        ...
        if (semanticHint == null) {
            visualID =
                    GraphsVisualIDRegistry.getNodeVisualID(containerView,
                            domainElement);
        } else {
    ...
    public Node createNode_2001(EObject domainElement, View containerView,
        ...
        Node label5003 =
                createLabel(node, GraphsVisualIDRegistry
    ...
    public Edge createEdge_4001(EObject domainElement, View containerView,
        ...
        Node label6001 =
                createLabel(edge, GraphsVisualIDRegistry
