...
import de.cau.cs.kieler.graphs.diagram.edit.policies.CompoundNode2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CompoundNode2EditPart extends ShapeNodeEditPart {
     ...
     * @generated
     */
    public CompoundNode2EditPart(View view) {
        super(view);
    }
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CompoundNode2ItemSemanticEditPolicy());
    ...
    protected IFigure createNodeShape() {
        CompoundNodeFigure figure = new CompoundNodeFigure();
     ...
     * @generated
     */
    public CompoundNodeFigure getPrimaryShape() {
        return (CompoundNodeFigure) primaryShape;
    }
    ...
    protected boolean addFixedChild(EditPart childEditPart) {
        if (childEditPart instanceof CompoundNodeLabel2EditPart) {
            ((CompoundNodeLabel2EditPart) childEditPart).setLabel(getPrimaryShape()
                    .getFigureCompoundNodeLabelFigure());
            return true;
        }
        return false;
    }
    ...
    public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
        ...
        if (targetEditPart instanceof de.cau.cs.kieler.graphs.diagram.edit.parts.CompoundNode2EditPart) {
            types.add(GraphsElementTypes.Edge_4001);
        }
        return types;
    }
     ...
     * @generated
     */
    public class CompoundNodeFigure extends RectangleFigure {

        /**
         * @generated
         */
        private WrappingLabel fFigureCompoundNodeLabelFigure;
        ...
        private void createContents() {
            ...
            fFigureCompoundNodeLabelFigure = new WrappingLabel();
         ...
         * @generated
         */
        public WrappingLabel getFigureCompoundNodeLabelFigure() {
     ...
     * @generated
     */
    static final Color THIS_BACK = new Color(null, 220, 250, 230);
