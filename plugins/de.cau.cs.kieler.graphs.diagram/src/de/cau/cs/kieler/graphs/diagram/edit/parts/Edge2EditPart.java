...
import de.cau.cs.kieler.graphs.diagram.edit.policies.Edge2ItemSemanticEditPolicy;
import de.cau.cs.kieler.graphs.diagram.part.GraphsDiagramEditorPlugin;

/**
 * @generated
 */
public class Edge2EditPart extends ConnectionNodeEditPart implements GraphsConnection,
        ITreeBranchEditPart {
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Edge2ItemSemanticEditPolicy());
    }
