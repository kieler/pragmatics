...
public class ElementInitializers {
    ...
    public static void init_Node_2002(Node instance) {
        try {
            Object value_0 =
                    GraphsOCLFactory.getExpression("true",
                            GraphsPackage.eINSTANCE.getNode()).evaluate(
                            instance);
            instance.setIsHypernode(((Boolean) value_0).booleanValue());
            Object value_1 =
                    GraphsOCLFactory.getExpression("\'Hypernode\'",
                            GraphsPackage.eINSTANCE.getNode()).evaluate(
                            instance);
    ...
    public static void init_Edge_4001(Edge instance) {
        try {
            Object value_0 =
                    GraphsOCLFactory.getExpression("true",
                            GraphsPackage.eINSTANCE.getEdge()).evaluate(
                            instance);
    ...
    public static void init_Edge_4003(Edge instance) {
        try {
            ...
            instance.setIsDirected(((Boolean) value_0).booleanValue());
            Object value_1 =
                    GraphsOCLFactory.getExpression(
