...
public class ElementInitializers {
	...
	public void init_Node_2002(Node instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(3,
					GraphsPackage.eINSTANCE.getNode(), null).evaluate(instance);
			instance.setIsHypernode(((Boolean) value_0).booleanValue());
			Object value_1 = GraphsOCLFactory.getExpression(4,
					GraphsPackage.eINSTANCE.getNode(), null).evaluate(instance);
	...
	public void init_Edge_4001(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(6,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4003(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(9,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
			instance.setIsDirected(((Boolean) value_0).booleanValue());
			Object value_1 = GraphsOCLFactory.getExpression(10,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4004(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(12,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4005(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(14,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
			instance.setIsDirected(((Boolean) value_0).booleanValue());
			Object value_1 = GraphsOCLFactory.getExpression(15,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4006(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(17,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4007(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(19,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
			instance.setIsDirected(((Boolean) value_0).booleanValue());
			Object value_1 = GraphsOCLFactory.getExpression(20,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
	...
	public void init_Edge_4008(Edge instance) {
		try {
			Object value_0 = GraphsOCLFactory.getExpression(22,
					GraphsPackage.eINSTANCE.getEdge(), null).evaluate(instance);
