...
public class GraphsVisualIDRegistry {
	...
	private static boolean isNode_2001(Node domainElement) {
		Object result = GraphsOCLFactory.getExpression(0,
				GraphsPackage.eINSTANCE.getNode(), null)
	...
	private static boolean isNode_2002(Node domainElement) {
		Object result = GraphsOCLFactory.getExpression(2,
				GraphsPackage.eINSTANCE.getNode(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isPort_3002(Port domainElement) {
		Object result = GraphsOCLFactory.getExpression(1,
				GraphsPackage.eINSTANCE.getPort(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4001(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(5,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4002(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(7,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4003(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(8,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4004(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(11,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4005(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(13,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4006(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(16,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4007(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(18,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
	...
	private static boolean isEdge_4008(Edge domainElement) {
		Object result = GraphsOCLFactory.getExpression(21,
				GraphsPackage.eINSTANCE.getEdge(), null)
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
