...
public class GraphsNewDiagramFileWizard extends Wizard {
    ...
    public GraphsNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot,
        ...
        myFileCreationPage.setDescription(NLS.bind(
                Messages.GraphsNewDiagramFileWizard_CreationPageDescription, GraphEditPart.MODEL_ID));
        IPath filePath;
        ...
        AbstractTransactionalCommand command = new AbstractTransactionalCommand(myEditingDomain,
            ...
            protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info)
                ...
                Diagram diagram = ViewService.createDiagram(diagramRootElementSelectionPage
                        .getModelElement(), GraphEditPart.MODEL_ID,
        ...
        protected boolean validatePage() {
            ...
            boolean result = ViewService.getInstance().provides(
                    new CreateDiagramViewOperation(new EObjectAdapter(selectedModelElement),
                            GraphEditPart.MODEL_ID, GraphsDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT));
