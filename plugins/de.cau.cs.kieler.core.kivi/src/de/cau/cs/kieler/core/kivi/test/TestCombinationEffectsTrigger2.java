 ...
 * such effect has been executed on the effects queue. Alternative way to implement
 * such effects listener by using the EffectsTrigger directly as parameter.
 * @author haf
 *
 */
public class TestCombinationEffectsTrigger2 extends AbstractCombination {

    public void execute(EffectTriggerState<TestEffectA> effect){
