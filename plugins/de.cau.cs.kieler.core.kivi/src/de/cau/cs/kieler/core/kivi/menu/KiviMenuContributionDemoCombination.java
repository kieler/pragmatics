...
public class KiviMenuContributionDemoCombination extends AbstractCombination {
    ...
    String[] buttonIds = {"de.cau.cs.kieler.core.kivi.demo.button1", "de.cau.cs.kieler.core.kivi.demo.button2"};
    ...
    public KiviMenuContributionDemoCombination() {
        ...
        ImageDescriptor icon = KiViPlugin.imageDescriptorFromPlugin(KiViPlugin.PLUGIN_ID, "icons/producer.png");
        String visibleIn = "org.eclipse.ui.DefaultTextEditor";
        KiviMenuContributionService.INSTANCE.addToolbarButton(this, buttonIds[1], "Demo Button 2", tooltip, icon, SWT.PUSH, null, visibleIn);
    }
