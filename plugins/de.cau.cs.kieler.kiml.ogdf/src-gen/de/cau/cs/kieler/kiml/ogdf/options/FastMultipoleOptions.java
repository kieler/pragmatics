...
public class FastMultipoleOptions implements ILayoutMetaDataProvider {
  /**
   * Property constant to access Precision from within the layout algorithm code.
   */
  public final static IProperty<Integer> MULTIPOLE_PREC = OgdfMetaDataProvider.MULTIPOLE_PREC;
  
  /**
   * Default value for {@link #ITERATIONS} with algorithm "Fast Multipole".
   */
  private final static int ITERATIONS_DEFAULT = 100;
