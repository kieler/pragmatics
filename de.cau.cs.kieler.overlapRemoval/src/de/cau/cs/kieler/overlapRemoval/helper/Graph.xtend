...
class Graph<V> {
	@Accessors val List<V> vertices = new ArrayList<V>()
	@Accessors val List<Edge<V>> edges = new ArrayList<Edge<V>>()
	@Accessors val HashMap<V, List<V>> adjMatrix = new HashMap<V, List<V>>()
	
	new() {	
	}
    
	new(List<V> pVertices) {
