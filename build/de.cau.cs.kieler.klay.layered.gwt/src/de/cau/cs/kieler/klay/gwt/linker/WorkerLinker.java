 ...
 * 
 * Derived from project Titaniumj Mobile, where it was described as "This linker removes unnecessary
 * GWT stuff to make the generated JS work inside Titanium TiMobileHybridLinker.java is part of Ti4j
 * 3.1.0 Copyright 2013 Emitrom LLC"
 * https://github.com/emitrom/titanium4j/blob/master/src/com/emitrom
 * /ti4j/mobile/linker/TiMobileLinker.java
 */
...
public class WorkerLinker extends AbstractLinker {
    ...
    public ArtifactSet link(TreeLogger logger, LinkerContext context, ArtifactSet artifacts)
        ...
        out.newline();
        out.print("else{ $wnd = {JSON: JSON}; }"); // gwtwwlinker - mind the $wnd.JSON passthrough
                                                   // used by autobeans
        out.newline();
        ...
        String filename = "klayjs_worker.js";
