		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGranaAccess().getJobsAssignment(), "rule__Grana__JobsAssignment");
					...
					put(grammarAccess.getResourceAccess().getPathAssignment_0(), "rule__Resource__PathAssignment_0");
					put(grammarAccess.getResourceAccess().getFilterAssignment_1_1(), "rule__Resource__FilterAssignment_1_1");
