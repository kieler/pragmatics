 ...
 */
public final class HierarchicalGraphBuilder {

	/** Constructor should not be public visible. */
	private HierarchicalGraphBuilder() {
		// Do nothing.
	}
	...
	private static void setLayoutAlgorithm(final KNode diagram, final String layoutAlgorithm) {
		if (layoutAlgorithm.equals("Radial")) {
			diagram.setProperty(CoreOptions.ALGORITHM, RadialOptions.ALGORITHM_ID);
		} else if (layoutAlgorithm.equals("Stress")) {
			diagram.setProperty(CoreOptions.ALGORITHM, HierarchicalStressOptions.ALGORITHM_ID);
		} else if (layoutAlgorithm.equals("Grid Snap")) {
//			diagram.setProperty(CoreOptions.ALGORITHM, Hier);
		} else if (layoutAlgorithm.equals("Tree")) {
			diagram.setProperty(CoreOptions.ALGORITHM, HierarchicalTreeOptions.ALGORITHM_ID);
