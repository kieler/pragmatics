 ...
 * @author cds
 */
public class ToggleLegendPaneAction extends Action {
    /**
     * The action's ID.
     */
    private static final String ACTION_ID = "de.cau.cs.kieler.klay.debugview.toggleLegendPane";
     ...
     */
    public ToggleLegendPaneAction(final DebugView debugView) {
        this.debugView = debugView;
        
        setId(ACTION_ID);
        setToolTipText(Messages.DebugWindow_Toolbar_ShowColorKey_ToolTip);
        setImageDescriptor(KlayDebugViewPlugin.imageDescriptorFromPlugin(
                KlayDebugViewPlugin.PLUGIN_ID,
                "images/colorKeys.gif"));
    }
    ...
    public void run() {
        ...
        debugView.setColorKeyVisible(newChecked);
    }
}
