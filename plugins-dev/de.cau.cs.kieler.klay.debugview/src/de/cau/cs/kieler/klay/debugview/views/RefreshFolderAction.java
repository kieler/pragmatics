 ...
 * @author cds
 */
public class RefreshFolderAction extends Action {
    /**
     * The action's ID.
     */
    private static final String ACTION_ID = "de.cau.cs.kieler.klay.debugview.refreshFolder";
     ...
     */
    public RefreshFolderAction(final DebugView debugView) {
        this.debugView = debugView;
        
        setId(ACTION_ID);
        setToolTipText(Messages.DebugWindow_Toolbar_RefreshFolder_ToolTip);
