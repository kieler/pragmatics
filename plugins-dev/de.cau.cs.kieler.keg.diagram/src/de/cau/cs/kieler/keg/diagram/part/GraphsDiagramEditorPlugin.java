...
import de.cau.cs.kieler.keg.kgraph.provider.KGraphItemProviderAdapterFactory;
...
public class GraphsDiagramEditorPlugin extends AbstractUIPlugin {
     ...
     * @generated
     */
    public static final String ID = "de.cau.cs.kieler.keg.diagram"; //$NON-NLS-1$
    ...
    public void logError(String error, Throwable throwable) {
        ...
        getLog().log(
                new Status(IStatus.ERROR, GraphsDiagramEditorPlugin.ID, IStatus.OK, error,
                        throwable));
    ...
    public void logInfo(String message, Throwable throwable) {
        ...
        getLog().log(
                new Status(IStatus.INFO, GraphsDiagramEditorPlugin.ID, IStatus.OK, message,
                        throwable));
