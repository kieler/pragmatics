...
import de.cau.cs.kieler.keg.diagram.edit.policies.Node5ItemSemanticEditPolicy;
...

{
    ...
    public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
        ...
        if (targetEditPart instanceof de.cau.cs.kieler.keg.diagram.edit.parts.Node5EditPart) {
            types.add(GraphsElementTypes.Edge_4001);
        }
        if (targetEditPart instanceof Node2EditPart) {
            types.add(GraphsElementTypes.Edge_4002);
