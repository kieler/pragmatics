...
public class Messages extends NLS {
    ...
    private static final String BUNDLE_NAME =
            "de.cau.cs.kieler.keg.diagram.custom.wizards.messages"; //$NON-NLS-1$
    ...
    public static String RandomGraphAnyPage_density_variance_caption;
    public static String RandomGraphAnyPage_density_variance_help;
    public static String RandomGraphAnyPage_description;
    public static String RandomGraphAnyPage_edges_description_caption;
    public static String RandomGraphAnyPage_edges_group_caption;
    ...
    public static String RandomGraphAnyPage_nodes_group_caption;
    ...
    public static String RandomGraphAnyPage_number_of_edges_variance_caption;
    public static String RandomGraphAnyPage_number_of_edges_variance_help;
    public static String RandomGraphAnyPage_rel_number_of_edges_caption;
    ...
    public static String RandomGraphAnyPage_number_of_nodes_max_help;
