 ...
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kiml.grana.text.grana.impl.AnalysisImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnalysisImpl extends MinimalEObjectImpl.Container implements Analysis
{
  ...
  {
    return GranaPackage.Literals.ANALYSIS;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GranaPackage.ANALYSIS__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GranaPackage.ANALYSIS__NAME:
        return getName();
    }
