...
public class LabelDummyRemoverTest extends AbstractLayeredProcessorTest {
    ...
    public void runUntil() {
        layered.getLayoutTestConfiguration().add(LayoutProcessorStrategy.LABEL_DUMMY_REMOVER.create());
    ...
    /**
     * No node exists with {@link NodeType} {@link NodeType#LABEL}. Only such nodes were
     * deleted.
     */
    @Test
